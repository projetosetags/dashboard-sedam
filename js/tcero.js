...
${podeEditar?`
<button onclick="novoTCERO()" class="bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2 rounded-2xl text-[11px] font-black shadow flex items-center justify-center min-w-[110px]">
INSERIR
</button>
`:''}
